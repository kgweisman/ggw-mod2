...
d1_all_fitDD <- cfa(modelDD, d1_all, ordered = TRUE)
...
# test model on study 1 (all conditions)
d1_all_fitWDM <- cfa(modelWDM, d1_all, ordered = TRUE)
...
# test model
d1_all_fitGGW <- cfa(modelGGW, d1_all, ordered = TRUE)
...
# test model
d2_all_fitDD <- cfa(modelDD, d2_all, ordered = TRUE)
...
# test model
d2_all_fitWDM <- cfa(modelWDM, d2_all, ordered = TRUE)
...
# test model
d2_all_fitGGW <- cfa(modelGGW, d2_all, ordered = TRUE)
...
# test model
d3_all_fitDD <- cfa(modelDD, d3_all, ordered = TRUE)
...
# test model
d3_all_fitWDM <- cfa(modelWDM, d3_all, ordered = TRUE)
...
# test model
d3_all_fitGGW <- cfa(modelGGW, d3_all, ordered = TRUE)
...
# test model
d4_all_fitDD <- cfa(modelDD, d4_all, ordered = TRUE)
...
dummy_fitDD <- cfa(modelDD_dummy, d4 %>%
                   select(subid, happy:pride), ordered = TRUE)
...
# test model
d4_all_fitWDM <- cfa(modelWDM, d4_all, ordered = TRUE)
...
# test model
d4_all_fitGGW <- cfa(modelGGW, d4_all, ordered = TRUE)
