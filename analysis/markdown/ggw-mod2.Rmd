...
# examine factor 1
kable(efa_d1_all_rotatedN_loadings %>% dplyr::select(mc, MR1) %>% arrange(desc(MR1)),
...
# examine factor 2
kable(efa_d1_all_rotatedN_loadings %>% dplyr::select(mc, MR2) %>% arrange(desc(MR2)),
...
# examine factor 3
kable(efa_d1_all_rotatedN_loadings %>% dplyr::select(mc, MR3) %>% arrange(desc(MR3)),
...
# examine factor 1
kable(efa_d2_all_rotatedN_loadings %>% dplyr::select(mc, MR1) %>% arrange(desc(MR1)),
...
# examine factor 2
kable(efa_d2_all_rotatedN_loadings %>% dplyr::select(mc, MR2) %>% arrange(desc(MR2)),
...
# examine factor 3
kable(efa_d2_all_rotatedN_loadings %>% dplyr::select(mc, MR3) %>% arrange(desc(MR3)),
...
# examine factor 1
kable(efa_d3_all_rotatedN_loadings %>% dplyr::select(mc, MR1) %>% arrange(desc(MR1)),
...
# examine factor 2
kable(efa_d3_all_rotatedN_loadings %>% dplyr::select(mc, MR2) %>% arrange(desc(MR2)),
...
# examine factor 3
kable(efa_d3_all_rotatedN_loadings %>% dplyr::select(mc, MR3) %>% arrange(desc(MR3)),
...
# examine factor 1
kable(efa_d4_all_rotatedN_loadings %>% dplyr::select(mc, MR1) %>% arrange(desc(MR1)),
...
# examine factor 1
kable(efa_d4_all_rotatedN_loadings %>% dplyr::select(mc, MR2) %>% arrange(desc(MR2)),
...
# examine factor 1
kable(efa_d4_all_rotatedN_loadings %>% dplyr::select(mc, MR3) %>% arrange(desc(MR3)),
