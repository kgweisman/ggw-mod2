...
efa_d1_beetle_unrotated <- fa(d1_beetle, 20, rotate = "none",
                              cor = "cor", fm = "minres")
...
# run EFA without rotation with N factors
efa_d2_robot_unrotated <- fa(d2_robot, 20, rotate = "none",
                             cor = "cor", fm = "minres")
...
# run EFA without rotation with N factors
efa_d1_all_unrotated <- fa(d1_all, 20, rotate = "none", 
                           cor = "cor", fm = "minres")
...
# run EFA without rotation with N factors
efa_d2_beetle_unrotated <- fa(d2_beetle, 20, rotate = "none",
                              cor = "cor", fm = "minres")
...
# run EFA without rotation with N factors
efa_d2_all_unrotated <- fa(d2_all, 20, rotate = "none", 
                           cor = "cor", fm = "minres")
...
# run EFA without rotation with N factors
efa_d3_all_unrotated <- fa(d3_all, 20, rotate = "none", 
                           cor = "cor", fm = "minres")
...
# run EFA without rotation with N factors
efa_d4_all_unrotated <- fa(d4_all, 20, rotate = "none", 
                           cor = "cor", fm = "minres")
