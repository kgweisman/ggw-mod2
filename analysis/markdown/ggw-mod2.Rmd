...
# run EFA without rotation with N factors
efa_d2_beetle_unrotatedN <- factanal(d2_beetle, nfactors_d2_beetle, r = "none")
...
```{r s2 beetle varimax rotation, echo = F}
# run EFA with rotation with N factors
efa_d2_beetle_rotatedN <- factanal(d2_beetle, nfactors_d2_beetle, r = "none")
...
```{r s2 beetle varimax rotation F1, echo = F}
# examine factor 1
...
```{r s2 beetle varimax rotation F2, echo = F}
# examine factor 2
...
```{r s2 beetle varimax rotation F3, echo = F}
# # examine factor 3
...
# run EFA without rotation with N factors
efa_d2_robot_unrotatedN <- factanal(d2_robot, nfactors_d2_robot, r = "none")
...
```{r s2 robot varimax rotation, echo = F}
# run EFA with rotation with N factors
efa_d2_robot_rotatedN <- factanal(d2_robot, nfactors_d2_robot, r = "none")
...
```{r s2 robot varimax rotation F1, echo = F}
# examine factor 1
...
```{r s2 robot varimax rotation F2, echo = F}
# examine factor 2
...
```{r s2 robot varimax rotation F3, echo = F}
# # examine factor 3
...
# run EFA without rotation with N factors
efa_d2_all_unrotatedN <- factanal(d2_all, nfactors_d2_all, r = "none")
...
# run EFA with rotation with N factors
efa_d2_all_rotatedN <- factanal(d2_all, nfactors_d2_all, r = "none")
...
# run EFA without rotation with N factors
efa_d3_all_unrotatedN <- factanal(d3_all, nfactors_d3_all, r = "none")
...
# run EFA with rotation with N factors
efa_d3_all_rotatedN <- factanal(d3_all, nfactors_d3_all, r = "none")
...
# run EFA without rotation with N factors
efa_d4_all_unrotatedN <- factanal(d4_all, nfactors_d4_all, r = "none")
...
# run EFA with rotation with N factors
efa_d4_all_rotatedN <- factanal(d4_all, nfactors_d4_all, r = "none")
