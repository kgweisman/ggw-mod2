...
```{r dataframes for dimension reduction, echo = F}
...
```{r s4 plot: AFFECT vs. AUTONOMY, echo = F, fig.height = 8, fig.width = 8}
...
```{r s4 plot: AFFECT vs. PERCEPTION, echo = F, fig.height = 8, fig.width = 8}
...
```{r s4 plot: AUTONOMY vs. PERCEPTION, echo = F, fig.height = 8, fig.width = 8}
