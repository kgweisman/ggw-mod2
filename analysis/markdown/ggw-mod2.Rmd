...
howManyFactors <- function (df) {
  ...
  #                              rotate = "oblimin", cor = "poly", plot = FALSE)
}
...
efa_d1_beetle_unrotatedN <- fa(d1_beetle, nfactors_d1_beetle, 
                               rotate = "none", cor = "poly", fm = "minres")
...
efa_d1_beetle_rotatedN <- fa(d1_beetle, nfactors_d1_beetle, 
                             rotate = "oblimin", cor = "poly", fm = "minres")
...
# run EFA without rotation with N factors
efa_d1_robot_unrotatedN <- fa(d1_robot, nfactors_d1_robot, 
                              rotate = "none", cor = "poly", fm = "minres")
...
# run EFA without rotation with N factors
efa_d1_all_unrotatedN <- fa(d1_all, nfactors_d1_all, 
                            rotate = "none", cor = "poly", fm = "minres")
...
if(chosenVarCoding == "continuous" & chosenEstimator == "ML") {
  # all set up so that model 2 predicted to be better than model 1
  vuongtest(d1_all_fitDD, d1_all_fitWDM) # compare DD to WDM
  vuongtest(d1_all_fitDD, d1_all_fitGGW) # compare DD to GGW
  vuongtest(d1_all_fitGGW, d1_all_fitWDM) # compare GGW to WDM
}
```
...
# run EFA without rotation with N factors
efa_d2_beetle_unrotatedN <- fa(d2_beetle, nfactors_d2_beetle, 
                               rotate = "none", cor = "poly", fm = "minres")
print(efa_d2_beetle_unrotatedN)

# get loadings for each factor
efa_d2_beetle_unrotatedN_loadings <- getFactorLoadings(efa_d2_beetle_unrotatedN)
```
...
# run EFA without rotation with N factors
efa_d2_robot_unrotatedN <- fa(d2_robot, nfactors_d2_robot, 
                              rotate = "none", cor = "poly", fm = "minres")
print(efa_d2_robot_unrotatedN)

# get loadings for each factor
efa_d2_robot_unrotatedN_loadings <- getFactorLoadings(efa_d2_robot_unrotatedN)
```
...
# run EFA without rotation with N factors
efa_d2_all_unrotatedN <- fa(d2_all, nfactors_d2_all, 
                            rotate = "none", cor = "poly", fm = "minres")
print(efa_d2_all_unrotatedN)

# get loadings for each factor
efa_d2_all_unrotatedN_loadings <- getFactorLoadings(efa_d2_all_unrotatedN)
```
...
if(chosenVarCoding == "continuous" & chosenEstimator == "ML") {
  # all set up so that model 2 predicted to be better than model 1
  vuongtest(d2_all_fitDD, d2_all_fitWDM) # compare DD to WDM
  vuongtest(d2_all_fitDD, d2_all_fitGGW) # compare DD to GGW
  vuongtest(d2_all_fitGGW, d2_all_fitWDM) # compare GGW to WDM
}
```
...
# run EFA without rotation with N factors
efa_d3_all_unrotatedN <- fa(d3_all, nfactors_d3_all, 
                            rotate = "none", cor = "poly", fm = "minres")
print(efa_d3_all_unrotatedN)

# get loadings for each factor
efa_d3_all_unrotatedN_loadings <- getFactorLoadings(efa_d3_all_unrotatedN)
```
...
if(chosenVarCoding == "continuous" & chosenEstimator == "ML") {
  # all set up so that model 2 predicted to be better than model 1
  vuongtest(d3_all_fitDD, d3_all_fitWDM) # compare DD to WDM
  vuongtest(d3_all_fitDD, d3_all_fitGGW) # compare DD to GGW
  vuongtest(d3_all_fitGGW, d3_all_fitWDM) # compare GGW to WDM
}
```
...
# run EFA without rotation with N factors
efa_d4_all_unrotatedN <- fa(d4_all, nfactors_d4_all, 
                            rotate = "none", cor = "poly", fm = "minres")
print(efa_d4_all_unrotatedN)

# get loadings for each factor
efa_d4_all_unrotatedN_loadings <- getFactorLoadings(efa_d4_all_unrotatedN)
```
...
modelWDM_dummy <- gsub("affect", "subid", modelWDM_dummy)
modelWDM_dummy <- gsub("autonomy", "subid", modelWDM_dummy)
modelWDM_dummy <- gsub("perception", "subid", modelWDM_dummy)
...
```{r s4 cfa modelWDM plot: affect vs. autonomy, echo = F, fig.height = 8, fig.width = 8}
ggplot(aes(x = affect_mean, y = autonomy_mean, colour = condition), 
  ...
  scale_x_continuous(limits = c(-3.6, 3.6), breaks = seq(-3, 3, 0.5)) +
  scale_y_continuous(limits = c(-3.6, 3.6), breaks = seq(-3, 3, 0.5)) +
  labs(title = "Study 4: Data-driven model, AFFECT vs. AUTONOMY\n(Error bars are 95% CIs)\n",
       x = "\nAverage score: AFFECT",
       y = "Average score: AUTONOMY\n")
```

```{r s4 cfa modelWDM plot: affect vs. perception, echo = F, fig.height = 8, fig.width = 8}
ggplot(aes(x = affect_mean, y = perception_mean, colour = condition), 
  ...
  scale_x_continuous(limits = c(-3.6, 3.6), breaks = seq(-3, 3, 0.5)) +
  scale_y_continuous(limits = c(-3.6, 3.6), breaks = seq(-3, 3, 0.5)) +
  labs(title = "Study 4: Data-driven model, AFFECT vs. PERCEPTION\n(Error bars are 95% CIs)\n",
       x = "\nAverage score: AFFECT",
       y = "Average score: PERCEPTION\n")
```

```{r s4 cfa modelWDM plot: autonomy vs. perception, echo = F, fig.height = 8, fig.width = 8}
ggplot(aes(x = autonomy_mean, y = perception_mean, colour = condition), 
  ...
  scale_x_continuous(limits = c(-3.6, 3.6), breaks = seq(-3, 3, 0.5)) +
  scale_y_continuous(limits = c(-3.6, 3.6), breaks = seq(-3, 3, 0.5)) +
  labs(title = "Study 4: Data-driven model, AUTONOMY vs. PERCEPTION\n(Error bars are 95% CIs)\n",
...
if(chosenVarCoding == "continuous" & chosenEstimator == "ML") {
  # all set up so that model 2 predicted to be better than model 1
  vuongtest(d4_all_fitDD, d4_all_fitWDM) # compare DD to WDM
  vuongtest(d4_all_fitDD, d4_all_fitGGW) # compare DD to GGW
  vuongtest(d4_all_fitGGW, d4_all_fitWDM) # compare GGW to WDM
}
```
