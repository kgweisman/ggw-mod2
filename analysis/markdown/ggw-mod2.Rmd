...
efa_d1_all_rotatedN <- fa(d1_all, nfactors_d1_all, 
                          rotate = "oblimin", cor = chosenCorType, fm = "minres")
...
efa_d4_all_rotatedN_scores_F1 <- efa_d4_all_rotatedN_scores %>%
  multi_boot(column = "MR1_rescale",
             summary_groups = "condition",
             statistics_functions = c("ci_lower", "mean", "ci_upper")) %>%
  rename(F1_ci_lower = ci_lower, F1_mean = mean, F1_ci_upper = ci_upper)

efa_d4_all_rotatedN_scores_F2 <- efa_d4_all_rotatedN_scores %>%
  multi_boot(column = "MR2_rescale",
             summary_groups = "condition",
             statistics_functions = c("ci_lower", "mean", "ci_upper")) %>%
    rename(F2_ci_lower = ci_lower, F2_mean = mean, F2_ci_upper = ci_upper)

efa_d4_all_rotatedN_scores_F3 <- efa_d4_all_rotatedN_scores %>%
  multi_boot(column = "MR3_rescale",
             summary_groups = "condition",
             statistics_functions = c("ci_lower", "mean", "ci_upper")) %>%
    rename(F3_ci_lower = ci_lower, F3_mean = mean, F3_ci_upper = ci_upper)
...
d4_f1f2 <- ggplot(aes(x = F1_mean, y = F2_mean, 
  ...
  scale_x_continuous(name = "Factor 1: Social-emotional",
                     limits = c(0, 1),
                     breaks = c(0, 1)) +
  scale_y_continuous(name = "Factor 2: Physiological",
                     limits = c(0, 1),
                     breaks = c(0, 1)) +
...
d4_f1f3 <- ggplot(aes(x = F1_mean, y = F3_mean, 
  ...
  scale_x_continuous(name = "Factor 1: Social-emotional",
                     limits = c(0, 1),
                     breaks = c(0, 1)) +
  scale_y_continuous(name = "Factor 3: Perceptual",
                     limits = c(0, 1),
                     breaks = c(0, 1)) +
  theme(text = element_text(size = 20),
        legend.position = "none") +
...
d4_f2f3 <- ggplot(aes(x = F2_mean, y = F3_mean, 
  ...
  theme_bw() +
  scale_color_manual(values = tol21rainbow) +
  scale_x_continuous(name = "Factor 2: Physiological",
                     limits = c(0, 1),
                     breaks = c(0, 1)) +
  scale_y_continuous(name = "Factor 3: Perceptual",
                     limits = c(0, 1),
...
```{r s4 plots, fig.width = 12, fig.height = 4}
